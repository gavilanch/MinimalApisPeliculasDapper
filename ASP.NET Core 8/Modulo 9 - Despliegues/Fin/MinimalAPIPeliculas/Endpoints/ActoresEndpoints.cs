...
namespace MinimalAPIPeliculas.Endpoints
{
    public static class ActoresEndpoints
    {
      ...
      .AgregarParametrosPaginacionAOpenAPI();
        ...
        static async Task<Ok<List<ActorDTO>>> ObtenerActores(
        ...
        static async Task<Results<Ok<ActorDTO>, NotFound>> ObtenerActorPorId(int id, IRepositorioActores repositorio,
            IMapper mapper)
        {
