...
namespace MinimalAPIPeliculas.Endpoints
{
    ...
    {
        private static string contenedor = "peliculas";
        ...
        public static RouteGroupBuilder MapPeliculas(this RouteGroupBuilder group)
        {
            ...
            group.MapGet("/", Obtener).CacheOutput(c => c.Expire(TimeSpan.FromSeconds(60)).Tag("peliculas-get")).AgregarParametrosPaginacionAOpenAPI();
